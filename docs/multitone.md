...
<a href="MultitoneSetup.zip">Download Multitone for 64-bit Windows v1.0.1   <input type="image" id="ma" alt="Multitone" src="images/multitone_logo.png" width="30" align="top" />   </a>
